...
const config = {
  ...
  OWNER_NAME: process.env.OWNER_NAME || "Lucas Md",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254110566555",
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "254740007567, 254110566555",
